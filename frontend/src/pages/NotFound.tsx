        ...
        <>
            ...
            <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center p-8">
                <div className="relative mb-8">
                    <div className="font-display text-[160px] font-light text-border leading-none select-none">
                        404
                    </div>
                ...
                <h1 className="font-display text-[28px] font-light text-foreground mb-3 tracking-tight">
                    Page not found
                </h1>
