...
const AUTH_USER_KEY = 'ledgr_user';
const AUTH_TOKEN_KEY = 'ledgr_token';
const AUTH_STORAGE_KEY = 'ledgr_use_session';
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({children}) => {
    ...
    const value = useMemo<AuthContextValue>(
        () => ({ user, isAuthenticated: !!user && !!token, login, logout, register, updateUser }),
